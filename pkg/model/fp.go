...
func (a byUpdatedDateInfo) Less(i, j int) bool { return a[i].UpdatedDate.Before(a[j].UpdatedDate) }
...
func (a byUpdatedDateInfoDesc) Less(i, j int) bool { return a[i].UpdatedDate.After(a[j].UpdatedDate) }
