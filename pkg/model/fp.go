...
func (a byCreationDateInfo) Less(i, j int) bool { return a[i].CreatedAt.Before(a[j].CreatedAt) }
...
func (a byCreationDateInfoDesc) Less(i, j int) bool { return a[i].CreatedAt.After(a[j].CreatedAt) }
...
type byUpdatedDateInfo []Info

func (a byUpdatedDateInfo) Len() int           { return len(a) }
func (a byUpdatedDateInfo) Less(i, j int) bool { return a[i].UpdatedAt.Before(a[j].UpdatedAt) }
func (a byUpdatedDateInfo) Swap(i, j int)      { a[i], a[j] = a[j], a[i] }

// SortInfoByUpdatedDate sort structs
func SortInfoByUpdatedDate(list []Info) []Info {
	if len(list) == 0 {
		return []Info{}
	}
	newList := make([]Info, len(list))
	...
	sort.Sort(byUpdatedDateInfo(newList))
	return newList
}

// SortInfoByUpdatedDatePtr sorts structs
func SortInfoByUpdatedDatePtr(list []*Info) []*Info {
	if len(list) == 0 {
		return []*Info{}
	}
	newList := make([]Info, len(list))
...
type byUpdatedDateInfoDesc []Info

func (a byUpdatedDateInfoDesc) Len() int           { return len(a) }
func (a byUpdatedDateInfoDesc) Less(i, j int) bool { return a[i].UpdatedAt.After(a[j].UpdatedAt) }
func (a byUpdatedDateInfoDesc) Swap(i, j int)      { a[i], a[j] = a[j], a[i] }

// SortInfoByUpdatedDateDesc sorts structs
func SortInfoByUpdatedDateDesc(list []Info) []Info {
	if len(list) == 0 {
		return []Info{}
	}
	newList := make([]Info, len(list))
	...
	sort.Sort(byUpdatedDateInfoDesc(newList))
	return newList
}

// SortInfoByUpdatedDateDescPtr sorts structs
func SortInfoByUpdatedDateDescPtr(list []*Info) []*Info {
	if len(list) == 0 {
		return []*Info{}
	}
	newList := make([]Info, len(list))
...
// UnionInfoByUpdatedDate return a set that is the union of the input sets
// repeated value within list parameter will be ignored
func UnionInfoByUpdatedDate(arrList ...[]Info) []Info {
	resultMap := make(map[time.Time]bool)
	var resultArr []Info
	for _, arr := range arrList {
		for _, v := range arr {
...
// Union<FTYPE>Ptr return a set that is the union of the input sets
// repeated value within list parameter will be ignored
func UnionInfoByUpdatedDatePtr(arrList ...[]*Info) []*Info {
	resultMap := make(map[time.Time]bool)
	var resultArr []*Info
	for _, arr := range arrList {
		for _, v := range arr {
...
// IntersectionInfoByUpdatedDate return a set that is the intersection of the input sets
// repeated value within list parameter will be ignored
func IntersectionInfoByUpdatedDate(arrList ...[]Info) []Info {
	if arrList == nil {
		return []Info{}
	}
...
// IntersectionInfoByUpdatedDatePtr return a set that is the intersection of the input sets
// repeated value within list parameter will be ignored
func IntersectionInfoByUpdatedDatePtr(arrList ...[]*Info) []*Info {
	if arrList == nil {
		return []*Info{}
	}
...
// DifferenceInfoByUpdatedDate returns a set that is the first set without elements of the remaining sets
// repeated value within list parameter will be ignored
func DifferenceInfoByUpdatedDate(arrList ...[]Info) []Info {
	if arrList == nil {
		return []Info{}
	}
...
// DifferenceInfoByUpdatedDatePtr returns a set that is the first set without elements of the remaining sets
// repeated value within list parameter will be ignored
func DifferenceInfoByUpdatedDatePtr(arrList ...[]*Info) []*Info {
	if arrList == nil {
		return []*Info{}
	}
...
// SubsetInfoByUpdatedDate returns true or false by checking if set1 is a subset of set2
// repeated value within list parameter will be ignored
func SubsetInfoByUpdatedDate(list1, list2 []Info) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
...
// SubsetInfoByUpdatedDatePtr returns true or false by checking if set1 is a subset of set2
// repeated value within list parameter will be ignored
func SubsetInfoByUpdatedDatePtr(list1, list2 []*Info) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
...
// SupersetInfoByUpdatedDate returns true or false by checking if set1 is a superset of set2
// repeated value within list parameter will be ignored
func SupersetInfoByUpdatedDate(list1, list2 []Info) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
...
// SupersetInfoByUpdatedDatePtr returns true or false by checking if set1 is a superset of set2
// repeated value within list parameter will be ignored
func SupersetInfoByUpdatedDatePtr(list1, list2 []*Info) bool {
	if list1 == nil || len(list1) == 0 || list2 == nil || len(list2) == 0 {
		return false
	}
...
// SetInfoByUpdatedDate returns a set of the distinct elements of coll.
func SetInfoByUpdatedDate(list []Info) []Info {
	if list == nil || len(list) == 0 {
		return []Info{}
	}
...
// SetInfoByUpdatedDatePtr returns a set of the distinct elements of coll.
func SetInfoByUpdatedDatePtr(list []*Info) []*Info {
	if list == nil || len(list) == 0 {
		return []*Info{}
	}
