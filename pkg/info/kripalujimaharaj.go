...
func getKripaluJiMaharajInfo() []Info {
	infoList := []Info{
		// Info1
		{
			Title: "Kripalu Ji Maharaj family",
			Info: `
Jagadguru Kripalu MaharajFamily

Mother: Bhagvati Devi
Father: Lalita Prasad Tripathi
Spouse: Padma Devi

Son: Balkrishna Tripathi

Daughter: Shyama Tripathi
Daughter: Krishna Tripathi
Daughter: Vishakha Tripathi

Son: Ghanshyam Tripathi
`,
			Link: []string{
...
`,
		...
		{
			Title: "Kripalu Ji Maharaj - Narad bhakti - part - 3",
			Info: `
Nice story about eknath and Gyaneshwar.
God will give everything needed to bhakta without asking.
`,
			Link: []string{
				"https://www.youtube.com/watch?v=YFfiph0pir8&list=PL3zx-BhgZPwRlrBdxuByXuE39X4SH3e6Q&index=3",
			},
...
The youtube link has nice story about Jaganath Mishra told by Kripalu Ji Maharaj
`,
			Link: []string{
